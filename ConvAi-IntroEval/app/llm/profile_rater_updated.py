...
def get_profile_rating_prompt(form_data: dict) -> str:
    ...
    extracted_fields = form_data.get("extracted_fields", "")
    ...
    {{
      ...
      IMPORTANT: Respond ONLY with the JSON object, no additional text. Calculate profile_rating as the sum of all category scores (completeness + relevance + projects_or_internships + extra_achievements), ensuring this sum matches the profile_rating value.
    """
